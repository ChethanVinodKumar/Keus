...
public class Binning_TablePage extends Testbase1 {
	...
	public Binning_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage BinningTable() throws InterruptedException {
