...
public class IQC_Confirmation_TablePage extends Testbase1 {
	...
	public IQC_Confirmation_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage IQC_Confirmation_Table() throws InterruptedException {
		...
		String ExpectedText = "GRIN IQC Confirmation";
