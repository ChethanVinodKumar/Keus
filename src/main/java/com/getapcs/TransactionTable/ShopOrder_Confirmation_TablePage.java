...
public class ShopOrder_Confirmation_TablePage extends Testbase1 {
	...
	public ShopOrder_Confirmation_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage ShopOrder_Confirmation_Table() throws InterruptedException {
		...
		String ExpectedText = "Shop Order Confirm";
