...
public class OQCBinningSA1 extends Testbase1 {
	...
	@FindBy(xpath = "//label[text()='Accepted SA Qty']/..//input[@class='form-control field2 ng-untouched ng-pristine ng-valid']")
