...
public class SalesOrder_TablePage extends Testbase1 {
	...
	public SalesOrder_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage SalesOrderTable() throws InterruptedException {
		...
		String ExpectedText = "Sales Order";
