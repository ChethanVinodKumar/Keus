...
public class VenderMasterEdit extends Testbase1 {
...
public HomePage VenderMasterEdit1(String comName,String comAlias,String add,
...
executor.executeScript("arguments[0].click();", terms);
	...
	boolean preferredFreightForwarderFieldIsSelected = preferredFreightForwarderFieldFocusedElement.equals(preferredFreightForwarder);
...
WebElement approvalDate = driver.findElement(By.xpath("(//input[@placeholder='DD-MM-YYYY'])[1]"));
	...
	robot.delay(2000);
	StringSelection stringSelection = new StringSelection("C:\\Users\\W2191\\Desktop\\testKeus\\SalesdefectsKeus.xlsx");
