...
public class OpenDeliveryOrder_Reports extends Testbase1 {
	...
	public OpenDeliveryOrder_Reports() {
...
//Purchase Requisition Items Details
		...
		String odoNum = driver.findElement(By.xpath(tableXpath + "/tbody/tr[1]/td[2]")).getText();

		String elementXpath = "(//div[normalize-space()='271223SO-000434'])[1]";

		String updatedXpath = elementXpath.replace("271223SO-000434", odoNum);
		...
		String customerName = driver.findElement(By.xpath(tableXpath + "/tbody/tr[1]/td[5]")).getText();
		...
		String customerAliasName = driver.findElement(By.xpath(tableXpath + "/tbody/tr[1]/td[6]")).getText();

		String elementXpath3 = "(//div[normalize-space()='271223SO-000434'])[1]";

		String updatedXpath3 = elementXpath3.replace("271223SO-000434", customerAliasName);
		...
		String updatedXpath4 = elementXpath4.replace("271223SO-000434", issuedTo);
		...
		SearchdeliveryOrderNumber.sendKeys(odoNum);
		...
		SearchcustomerAliasName1.sendKeys(issuedTo);
		...
		SearchcustomerId.sendKeys(issuedTo);
