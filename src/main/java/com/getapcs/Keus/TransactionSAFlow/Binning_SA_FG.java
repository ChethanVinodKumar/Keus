...
public class Binning_SA_FG extends Testbase1 {
...
//	##1111
	...
	@FindBy(xpath = "(//span[normalize-space()='HYD-BHRD3-Room3'])[1]")
	WebElement locationSelect1;

//###222

	@FindBy(xpath = "(//span[normalize-space()='HYD-ATNR'])[1]")
	WebElement warehouseSelect2;

	@FindBy(xpath = "(//span[normalize-space()='HYD-ATNR-GF'])[1]")
	WebElement locationSelect2;

	@FindBy(xpath = "(//span[normalize-space()='HYD-ATNR'])[1]")
	WebElement warehouseSelect22;

	@FindBy(xpath = "(//span[normalize-space()='HYD-ATNR-FF'])[1]")
	...
	@FindBy(xpath = "(//span[normalize-space()='TEST Location 1'])[1]")
	...
	@FindBy(xpath = "(//span[normalize-space()='Room No 2'])[1]")
	WebElement locationSelect44;

	// ###5555

	@FindBy(xpath = "(//span[normalize-space()='HYD-REWORK'])[1]")
	WebElement warehouseSelect5;

	@FindBy(xpath = "(//span[normalize-space()='HYD-REWORK-ROOM1'])[1]")
	WebElement locationSelect5;

	@FindBy(xpath = "(//span[normalize-space()='HYD-BH-RD5'])[1]")
	WebElement warehouseSelect55;

	@FindBy(xpath = "(//span[normalize-space()='Room No 3'])[1]")
	...
	@FindBy(xpath = "(//span[normalize-space()='Hyderabad-BHills-Road#1'])[1]")
	WebElement locationSelect6;

	@FindBy(xpath = "(//span[normalize-space()='HYD-BH-RD3'])[1]")
	WebElement warehouseSelect66;

	@FindBy(xpath = "(//span[normalize-space()='Hyderabad-BHills-Road#2'])[1]")
