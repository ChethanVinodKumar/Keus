...
//Customer Approval
	...
	WebElement customerCategorySelect;
	...
	public HomePage CustomerMasterCreate(String cusId, String cusName, String cusAlias, String add, String cty,
			...
			String erp2, String osp2, String approved) throws Exception {// customerId.sendKeys(cusId);
...
//  		assertTrue(isEnablederpField);
		...
		click(driver, customerCategory);
		click(driver, customerCategorySelect);
