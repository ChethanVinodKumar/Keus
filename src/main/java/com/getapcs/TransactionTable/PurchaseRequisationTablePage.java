...
public class PurchaseRequisationTablePage extends Testbase1 {
	...
	public PurchaseRequisationTablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage PurchaseRequisationTable() throws Exception {
		...
		String ExpectedText = "Purchase Requisition";
...
// Pagination
		...
		// Usage
		paginate(driver, 1, 3, true); // forward
		paginate(driver, 1, 3, false); // backward
