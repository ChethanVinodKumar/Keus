...
public class OQC_Binning_TablePage extends Testbase1 {
	...
	public OQC_Binning_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage OQC_Binning_Table() throws InterruptedException {
		...
		String ExpectedText = "OQC-BINNING";
