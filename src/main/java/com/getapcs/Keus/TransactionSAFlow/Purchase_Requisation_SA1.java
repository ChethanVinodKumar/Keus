...
public class Purchase_Requisation_SA1 extends Testbase1 {
...
//******************************************************PR CREATE*************************************************// 
	...
	public HomePage prCreatePage() throws Throwable {
		...
		// Get the first PR number text from table
		String ItemNumber = driver.findElement(By.xpath(tableXpath + "/tbody/tr[2]/td[3]/div")).getText();

		String ItemNumber1 = driver.findElement(By.xpath(tableXpath + "/tbody/tr[3]/td[3]/div")).getText();

		String reqQty1 = driver.findElement(By.xpath(tableXpath + "/tbody/tr[3]/td[7]/div")).getText();
