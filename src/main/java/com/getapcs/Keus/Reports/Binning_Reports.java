...
public class Binning_Reports extends Testbase1 {
	...
	public HomePage Binning_Reports_Page() throws Exception {
...
//Purchase Requisition Items Details
		...
		String venderName1 = driver.findElement(By.xpath(tableXpath + "/tbody/tr[1]/td[5]")).getText();
