...
public class ShopOrder_TablePage extends Testbase1 {
	...
	public ShopOrder_TablePage() {
		PageFactory.initElements(driver, this);
	}

	public HomePage ShopOrderTable() throws Exception {
		...
		String ExpectedText = "Shop Order";
