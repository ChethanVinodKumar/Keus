...
public class Engg_BOM_Create_Page_FOR_FG extends Testbase1 {
...
//       activeStatusToggleButton.click();
		...
		WebElement itemNumberForChildItemDataSelect1 = driver.findElement(By.xpath(updatedXpathSA2));
		...
		WebElement itemNumberForChildItemDataSelect2 = driver.findElement(By.xpath(updatedXpathPP5));
		...
		WebElement itemNumberForChildItemDataSelect3 = driver.findElement(By.xpath(updatedXpathPP6));
		click(driver, itemNumberForChildItemDataSelect3);
		...
		isSelected(driver, alternateItemDropDown, "alternateItemDropDown");
		Thread.sleep(1000);
		click(driver, alternateItemDropDownDataSeelect2);
		...
		click(driver, itemNumberDropDowninNRE);
		isSelected(driver, itemNumberDropDowninNRE, "itemNumberDropDowninNRE");
		click(driver, itemNumberDropDowninNREDataSelect2);
		...
		System.out.println("\n" + "Engg_BOM_Create_Page_FOR_FG  Ended" + "\n");
